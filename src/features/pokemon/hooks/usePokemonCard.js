...
import { makeSelectPokemonById } from "@/features/pokemon/state/pokemonSelectors";
...
export const usePokemonCard = (pokemonId) => {
    ...
    // Optimización: selector factory con createSelector para memoización correcta
    const selectPokemon = useMemo(() => makeSelectPokemonById(), []);
