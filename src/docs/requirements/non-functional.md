...
- **Descripción:** La aplicación debe ser accesible para usuarios con discapacidades visuales o motoras leves, siguiendo las pautas WCAG 2.1 (nivel AA) mediante HTML semántico y atributos ARIA.
- **Métrica:** Puntuación en herramientas de auditoría de accesibilidad (ej. Lighthouse).

### RNF2.3 - Consistencia de la UI

- **Descripción:** La interfaz de usuario debe mantener una apariencia y un comportamiento consistentes en toda la aplicación, utilizando el sistema de diseño basado en Tailwind CSS.
- **Métrica:** Revisión visual y adherencia al sistema de diseño (tokens de Tailwind).
...
_Este documento es generado y mantenido automáticamente como parte de la documentación del proyecto._
